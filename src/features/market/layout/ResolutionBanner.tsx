        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              This market has ended and is awaiting resolution. The outcome will
              be announced soon.
            </p>
            <p className="text-xs text-muted-foreground mt-2">
              Market ended:{" "}
              {dayjs(market.endsAt).format("MMM D, YYYY [at] h:mm A")}
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div
      className={cn(
        ...
        resolvedToYes ? "border-yes/30 bg-yes/5" : "border-no/30 bg-no/5",
      )}
    >
      <div className="flex items-start gap-4">
        {/* Resolution Icon */}
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            This market has been resolved. {resolvedToYes ? "YES" : "NO"}{" "}
            positions paid out ₦1.00 per share.
          </p>
          ...
          <p className="text-xs text-muted-foreground mt-3">
            Resolved:{" "}
            {dayjs(market.resolutionDate || market.endsAt).format(
