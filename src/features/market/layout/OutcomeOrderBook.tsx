...
export function OutcomeOrderBook({ outcomes, generateOrderBook }: OutcomeOrderBookProps) {
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isSelected ? 'bg-surface border-2 border-primary' : 'hover:bg-surface/50'
              )}
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    ${(outcome.volume || Math.floor(Math.random() * 5000000)).toLocaleString()} Vol.
                  </p>
                </div>
              </div>
          ...
          <div className="p-4">
            ...
            <div className="overflow-hidden">
              ...
              <div className="relative">
                {orderBook.asks.slice().reverse().slice(0, 4).map((ask, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="relative text-right text-foreground font-mono">
                        {ask.quantity.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-surface text-sm">
                <span className="text-muted-foreground">Last: {Math.round(lastPrice * 100)}¢</span>
                <span className="text-muted-foreground">Spread: {Math.round(spread * 100)}¢</span>
              </div>
                ...
                {orderBook.bids.slice(0, 4).map((bid, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="relative text-right text-foreground font-mono">
                        {bid.quantity.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                      <span className="relative text-right text-muted-foreground font-mono">
                        ${(total / 100).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
